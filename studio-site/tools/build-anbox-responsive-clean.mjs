...
function finalMobileCss(part) {
  ...
  if (part === '03') return `${css}.anbox-mobile-part--03 .portfolio-gate-spacer{position:relative!important;z-index:0!important;min-height:calc(100vh - var(--abm-gallery-top))!important;min-height:calc(100svh - var(--abm-gallery-top))!important;pointer-events:none!important;overflow-anchor:none}.anbox-mobile-part--03 .portfolio-gate-spacer[hidden]{display:none!important}`;
