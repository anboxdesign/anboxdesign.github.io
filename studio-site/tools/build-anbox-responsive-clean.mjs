...
.anbox-desktop-part--00.abh{transition:none!important}
  ...
  if (part === '01') {
    return `.anbox-desktop-part--01 .abh-hero__shelf-track{width:max-content!important;display:flex!important;animation:abh-retail-shelf 32s linear infinite!important}.anbox-desktop-part--01 .abh-hero__shelf-group{width:auto!important;padding:0 24px!important;display:flex!important;grid-template-columns:none!important;flex:0 0 auto!important;gap:48px!important}.anbox-desktop-part--01 .abh-hero__brand{padding:0!important}.anbox-desktop-part--01 .abh-hero__brand img{width:auto!important;max-width:180px!important;height:32px!important}.anbox-desktop-part--01 .abh-hero__brand:first-child img{transform:translateY(1px)}.anbox-desktop-part--01 .abh-hero__brand:nth-child(2) img{height:46px!important}.anbox-desktop-part--01 .abh-hero__brand:nth-child(7) img{height:25px!important}.anbox-desktop-part--01 .abh-hero__brand:nth-child(8) img{height:23px!important}@keyframes abh-retail-shelf{from{transform:translate3d(0,0,0)}to{transform:translate3d(-33.333333%,0,0)}}`;
  }
  if (part === '02') {
