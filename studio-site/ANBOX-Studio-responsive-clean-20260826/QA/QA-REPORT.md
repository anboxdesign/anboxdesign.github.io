...
- Очистка: объём блоков уменьшен на 23.1%; повторных scroll-replay runtime — 0; подключений Onest — 1.
...
- desktop HERO shelf: loaded 1/8 retailer logos
- mobile HERO shelf: loaded 1/8 retailer logos
